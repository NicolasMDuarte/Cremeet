  ...
  if (!temFunc) {
    ...
    if (_valueSendEmail) {
      try {
        Email email = Email(
          body:
              "Um de seus convites foi alterado para ${tipoEvento.toString()} em ${localEvento.toString()} às ${horaEvento.toString()} do dia ${dataEvento.toString()} por ${donoReuniao.toString()}. Não deixe de comparecer!",
          subject: "Cremeet - Reunião alterada",
...
class SelecionarEditarEvento extends StatefulWidget {
  @override
  _SelecionarEditarEventoState createState() => _SelecionarEditarEventoState();
}

class _SelecionarEditarEventoState extends State<SelecionarEditarEvento> {
  @override
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Container(
                child: ElevatedButton(
                    onPressed: () => setState(() => selecionados()),
                    child: Text("Importar")),
